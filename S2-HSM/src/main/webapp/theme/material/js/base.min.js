if (! function(a, b, c) {
        ...
        a.Modernizr = m
    }(window, document), "undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(a) {
    "use strict";
...
function(a) {
    ...
    function(a) {
        ...
        a.fn.menu = b, a.fn.menu.Constructor = c, a.fn.menu.noConflict = function() {
            ...
            var d = a(this),
                e = d.attr("href"),
                f = a(d.attr("data-target") || e && e.replace(/.*(?=#[^\s]+$)/, "")),
                g = f.data("bs.menu") ? "toggle" : a.extend({
                    remote: !/#/.test(e) && e
                }, f.data(), d.data());
    ...
    function(a) {
        ...
        Waves.attach(".waves-attach"), Waves.init({
            duration: 600
        })
    });